...
describe('ATokenYieldSource', () => {
  ...
  describe('sponsor()', () => {
    ...
    it('should sponsor Yield Source', async () => {
      ...
      // await aTokenYieldSource.mint(yieldSourceOwner.address, wallet2Amount);
      ...
      const bal = await aTokenYieldSource.callStatic.balanceOfToken(wallet2.address)
      console.log('bal: ', bal.toString(), amount.add(wallet2Amount).toString())
